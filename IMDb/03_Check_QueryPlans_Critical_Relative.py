...
def identify_critical_misestimates(input_file, output_csv, threshold=10.00):
    critical_entries = []
...
output_csv = '/Users/lui/PycharmProjects/BachelorProject_Ludwig_V2/IMDb/Resultfiles/CRITICAL_values_bias_5.00.csv'
