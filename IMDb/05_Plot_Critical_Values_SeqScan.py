...
class QueryAnalyzer:
    ...
    def filter_queries(self):
        ...
        self.df = self.df[self.df['Node Type'] == 'Seq Scan']
    ...
    def plot_deviation(self):
        ...
        plt.title('Deviation Between Estimated and Actual Rows for Seq Scan by Query')
        plt.xlabel('Query Name')
        plt.xticks(rotation=45, ha='right')
        plt.ylabel('Deviation (in rows)')

        # Adjust x-axis labels: Only show every suitable label
