...
class QueryAnalyzer:
    ...
    def filter_queries(self):
        ...
        # Further filter for rows where the Node Type is 'Index Only Scan'
        self.df = self.df[self.df['Node Type'].str.strip() == 'Index Only Scan']
    ...
    def plot_deviation(self):
        ...
        plt.title('Deviation Between Estimated and Actual Rows for Index Scan by Query')
